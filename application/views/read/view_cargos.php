        ...
        <div class="col-sm-12">
              <div class="row float-left">
                <?php echo form_open_multipart('controller_cargos/agregar');
                  ...
                  {
                ?>
                    <button type="submit" class="btn btn-outline-info btn-sm"><i class="fa fa-database"></i> Agregar Cargos</button>
                <?php
                  } 
                echo form_close();
                echo form_open_multipart('controller_cargos/eliminados');?>
                    <button  type="submit" class="btn btn-outline-info btn-sm"><i class="fa fa-trash"></i> Cargos Eliminados</button>
                <?php echo form_close();?>
                    ...
                    <ul >
                      <li   class="nav-item dropdown open text-center" style="list-style:none;">
                        <a href="<?php echo base_url(); ?>gentelella/javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-align-justify"></i>
                          ...
                          <?php echo form_close(); 
                          echo form_open_multipart('controller_cargos/eliminarbd');?>    
                            <input type="hidden" name="idCargo" value="<?php echo $row->idCargo;?>">
