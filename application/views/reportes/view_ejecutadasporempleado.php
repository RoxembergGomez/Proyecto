  ...
  <div class="x_panel">
    <div class="x_title text-center">
      ...
      <?php echo form_close();?>
        ...
        <h5 >LISTA DE ACTIVIDADES EJECUTADAS POR EMPLEADOS</h5> 
    </div>
    <div class="x_content">
      <div class="row">
        <div class="col-sm-12">
          <div class="row float-right">
            <?php echo form_open_multipart('controller_actividades/reporteporempleadopdf');?>
            <input type="hidden" name="idEmpleado" value="<?php echo $_POST['idEmpleado'];?>">
            <input type="hidden" name="estadoEjecucion" value="<?php echo $_POST['estadoEjecucion'];?>">
            ...
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
              ...
              ?>
                 <tr>
                  ...
                  if ($row->estadoEjecucion=='3') { ?><p id="verde">Ejecutado</p><?php
                  };
                  if ($row->estadoEjecucion=='1') { ?><p id="azul">Asignado</p><?php
                  };?>
                  </td>
                </tr>
            <?php
